...
<template>
    <div class="section full-height">
        ...
        />
        <div id="feelsLike-container">
            <p id="feelsLikeTemperature" class="text-highlight-1">{{ Math.round(weatherData.main.feels_like) }}°</p>
            ...
            <p id="temperatureComment">{{ getFeelsLikeComment((Math.round(weatherData.main.temp)), Math.round(weatherData.main.feels_like)) }}</p>
        </div>
    </div>
</template>
